...
> **📝 Personal Note** — I'm using this fork primarily to experiment with Gemini models and to study the self-evolution mechanism. The <30K token budget is what drew me here — most other agent frameworks are way too expensive to run casually.
